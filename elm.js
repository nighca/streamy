...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{parsed: elm$core$Maybe$Nothing, script: 'inited'},
		elm$core$Platform$Cmd$none);
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Ports$scriptParsed = _Platform_incomingPort('scriptParsed', elm$json$Json$Decode$value);
var author$project$Update$ScriptParsed = function (a) {
	return {$: 'ScriptParsed', a: a};
};
var author$project$Main$subscriptions = function (_n0) {
	return author$project$Ports$scriptParsed(author$project$Update$ScriptParsed);
};
var author$project$Lang$Tree$TextStatement = function (a) {
	return {$: 'TextStatement', a: a};
};
var elm$core$Basics$identity = function (x) {
	return x;
};
var author$project$Lang$Tree$extractTree = function (value) {
	return {
		statements: _List_fromArray(
			[
				author$project$Lang$Tree$TextStatement('test')
			])
	};
};
var author$project$Ports$scriptToParse = _Platform_outgoingPort('scriptToParse', elm$core$Basics$identity);
...
var author$project$Update$update = F2(
	function (msg, model) {
		if (msg.$ === 'ScriptInput') {
			var newScript = msg.a;
			var _n1 = A2(elm$core$Debug$log, 'script', newScript);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{script: newScript}),
				author$project$Ports$scriptToParse(
					elm$json$Json$Encode$string(newScript)));
		} else {
			var parsed = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						parsed: elm$core$Maybe$Just(
							author$project$Lang$Tree$extractTree(parsed))
					}),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$View$Canvas$view = function (maybeTree) {
	if (maybeTree.$ === 'Nothing') {
		...
		var tree = maybeTree.a;
		return A2(
			elm$html$Html$p,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('view-canvas')
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					elm$core$String$fromInt(
						elm$core$List$length(tree.statements)))
				]));
	}
};
var author$project$Update$ScriptInput = function (a) {
	return {$: 'ScriptInput', a: a};
};
...
var author$project$View$Editor$view = function (script) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('view-editor')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onInput(author$project$Update$ScriptInput)
					]),
				_List_Nil)
			]));
};
...
var author$project$View$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('view-index')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('editor-wrapper')
					]),
				_List_fromArray(
					[
						A2(
						...
						author$project$View$Editor$view(model.script)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('canvas-wrapper')
					]),
				_List_fromArray(
					[
						A2(
						...
						author$project$View$Canvas$view(model.parsed)
					]))
			]));
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$Main$init, subscriptions: author$project$Main$subscriptions, update: author$project$Update$update, view: author$project$View$Main$view});
